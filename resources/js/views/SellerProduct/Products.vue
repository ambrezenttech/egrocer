    ...
    data: function () {
        return {
            ...
            fields: [
                ...
                {key: 'price', label: __('price'), visible: true, class: 'text-center', sortable: true},
                {key: 'discounted_price', label: __('discounted_price'), visible: true, class: 'text-center', sortable: true},
